...
void launch_shell(int n)
{
	...
	do
	{
		    ...
		    if(strEql(ch,"cmd"))
		    {
		            print("\nI opened another shell, just for you. xoxo\n");
					launch_shell(n+1);
		    }
		    else if(strEql(ch,"penis"))
		    {
			print("\no====3 lol\n");
		    }
		    ...
		    {
		            print("\nInvalid command. No shirt, no service.\n");
		            print("midOS> ");
		    } 
...
void sort()
{
	...
	print_array(arr,n);
	print("\nOrder: (1 to  increase/ 0 to decrease): ");
...
void help()
{
	print("\ncmd       : If you want to multitask on a text-based OS.");
	print("\nclear     : Clears the screen but doesn't clear your soul of sin.");
	print("\nsum       : Computes the sum of n numbers.");
	print("\necho      : It's like speaking into a canyon");
	print("\nsort      : Sorts out your shit for you.");
	print("\nfibonaci  : Prints the first n numbers of a Fibonaci sequence.");
	print("\ngcd       : Computes the greatest common diviser of n given numbers.");
	print("\nexit      : Tells the current Shell you're going for a pack of cigarettes.");
	print("\ncolor     : Pimp My Ride, except with the command prompt.");
