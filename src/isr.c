...
string exception_messages[] = {
    "ERROR 00 DivByZero: Some dumbass tried to divide by zero.",
    "ERROR 01 DebugMsg: Standard debug message.",
    "ERROR 02 IntNoID: This interrupt refused to give me his ID.",
    "ERROR 03 BreakPNT: Breakpoint.",
    "ERROR 04 Overflow: Don't swim into the detected overflow.",
    "ERROR 05 OutOfBnds: Stop, god, fuck, it's out of bounds!",
    "ERROR 06 InvOpcode: Wrong opcode, buddy.",
    "ERROR 07 NoCoproc: We're all out of coprocessors.",

    "ERROR 08 DoubleFault: Two fuck ups at the same time? I'm impressed.",
    "ERROR 09 CoprocOverrun: Every segment of the coprocessor has been overrun.",
    "ERROR 10 BadTSSProtocol: Bad dum, TSS.",
    "ERROR 11 SegmentAbsent: Your segment swiped left.",
    "ERROR 12 StackFault: Don't stack too hard.",
    "ERROR 13 GProtectionFault: We're not allowed in here. Contact your admin.",
    "ERROR 14 PageFault: Standard page error.",
    "ERROR 15 UnknownInterrupt: Jesus Christ, Denton.",
