...
build:all
	...
	rm extern/boot/grub/ -r -f
	mkdir extern/boot/grub/
	echo set default=0 >> extern/boot/grub/grub.cfg
	echo set timeout=0 >> extern/boot/grub/grub.cfg
	echo menuentry "midOS" { >> extern/boot/grub/grub.cfg
	echo         set root='(hd96)' >> extern/boot/grub/grub.cfg
	echo         multiboot /boot/kernel.bin >> extern/boot/grub/grub.cfg
	echo } >> extern/boot/grub/grub.cfg

	grub-mkrescue -o midOS.iso extern/
